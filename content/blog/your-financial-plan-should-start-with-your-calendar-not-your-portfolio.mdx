...
I did it that way for years. As an advisor at a large national firm, that's how I was trained. Gather the data. Run the projections. Show the Monte Carlo simulation. Move on to the next client.
