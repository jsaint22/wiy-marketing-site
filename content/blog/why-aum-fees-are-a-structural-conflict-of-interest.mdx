...
AUM fees compound. As your portfolio grows, the fee grows with it. At 7% annual growth — a reasonable long-term assumption — your $5 million portfolio becomes roughly $19.3 million after 20 years. Your AUM advisor is now billing you $193,000 a year. For the same advice. For the same number of meetings. For the same plan.

Over 20 years at that $5 million starting point, the illustrative cumulative difference between 1% AUM fees and a flat-fee model is approximately **$1.49 million**.

Extend that to 30 years and the gap widens to approximately **$3.72 million**.
...
*(These figures are illustrative, based on a 7% annual growth rate and the WIY flat-fee schedule. Your specific numbers depend on your situation. Download [The AUM Math PDF](/api/aum-math) for the full side-by-side breakdown at multiple net worth levels.)*
