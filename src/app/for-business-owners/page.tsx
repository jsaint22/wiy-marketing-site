  ...
  return (
    <>
      ...
      <section className="bg-secondary/10 py-10 sm:py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-xs font-semibold text-secondary uppercase tracking-wider mb-3">Roadmap</p>
          <h2 className="text-2xl sm:text-3xl font-bold text-primary">
          ...
          <p className="mt-4 text-neutral-dark/70 leading-relaxed max-w-xl mx-auto">
            ...
            team you need before you exit, or before your next growth phase.
          </p>
          <Link
